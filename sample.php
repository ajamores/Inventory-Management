...
<body class="bg-gray-100">
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-gray-800 text-white flex-shrink-0">
            ...
            <nav class="mt-6">
                <a href="#" class="flex items-center px-6 py-3 bg-gray-900 border-l-4 border-blue-500">
                        ...
                        <table class="w-full">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Commercial Oven</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">SKU-001</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Kitchen Equipment</td>
                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Gas Range</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">SKU-002</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Kitchen Equipment</td>
                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Countertop Grill</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">SKU-003</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Grills</td>
                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Griddle</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">SKU-004</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Kitchen Equipment</td>
                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Conveyor Oven</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">SKU-005</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Kitchen Equipment</td>
